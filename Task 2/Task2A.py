...
def get_filter_spd(df):
    ...
    df = df[df['Offense Parent Group'].isin(['ASSAULT OFFENSES',
            'HOMICIDE OFFENSES', 'BURGLARY/BREAKING&ENTERING', 'SEX OFFENSES',
...
def ploting_lines(df):
    ...
    NR_burglary_df = filtering_crime_type(df, 
      'DESTRUCTION/DAMAGE/VANDALISM OF PROPERTY')
    ...
    fig, [[ax1, ax2], [ax3, ax4], [ax5, ax6], [ax7, ax8]] = \
            plt.subplots(4, figsize=(10, 10), ncols=2)
...
def main():
    ...
    '''
    # raw data
    spd = pd.read_csv('~/Desktop/CSE/CSE 163/project/part 2/Task 2/' +
